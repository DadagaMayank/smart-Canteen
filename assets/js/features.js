    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">Meal</span><span class="clr-green">Canteen</span></h1></a>
                </div>
                <!-- Toggle Bars -->
            ...
            <div class="cart-innerlay">
                ...
                <div class="cart-footer text-center sm">
                    ...
                    <div class="my-1">
                        ...
                        <button class="check-out btn">Order Now</button>
                    </div>
                </div>
            </div>
        </section>
    ...
    mobPreviewNavbar.innerHTML = `
        <nav class="nav container">
            <ul class="mob-ul">
                ...
                <li><a href="our-vision.html">Our Vision</a></li>
                <li><a href="user-orders.html"><i class="far fa-eye"></i>Your-Orders</a></li>
        ...
        customerFooter.forEach(element => {
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    <!-- About College -->
                    <article class="about jaimin_p">
                        <h1 class="sm jaimin_footer_heading">About Us</h1>
                    ...
                    <article class="quick-links">
                        <ul>
                            <h1 class="sm jaimin_footer_heading_2 ">Quick Links</h1>
                            <li><a href="index.html">Canteen Home</a></li>
                            <li><a href="client-side.html">Canteen Menu</a></li>
                            <li><a href="our-vision.html">Our Vision</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
                        <ul>
                            <h1 class="sm jaimin_footer_heading_2">Contact Information</h1>
                            <li> <i class="fas fa-phone-alt"></i> <p>+91 9979082032</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>patelmayank0.pm@gmail.com</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Damubhai hostel, Navrangpura Ahmedabad 380009.</p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p>For Eny Queres, Visit: www.silveroakuni.com</p></li>
                        </ul>
                    </article>
                </main>
                <!-- Deep Devs Info -->
                <main class="deep-devs flex">
                    ...
                    <div class="">Designed & Developed with <i class="fas fa-heart clr-red"></i> By <a href="#">Silveroak Students</a></div>
                </main>
            </section>
        `;
        })
